  ...
  return (
    ...
    <div className='categories' style={{listStyle:'none'}}>
      ...
      <div className='satelite my-5'>
       ...
       <hr/>
        <AiOutlineCalendar/> November 16, 2020  <FaUserTie/> administrator  <AiFillFolderOpen/> Other
        <hr/>
        ...
        <hr/>
        <AiOutlineCalendar/> November 16, 2020  <FaUserTie/> administrator <AiFillFolderOpen/> Other, People <AiFillTag/> fashion <FaCommentAlt/> Leave a Comment
        <hr/>
        ...
        <hr/>
        <AiOutlineCalendar/> November 16, 2020  <FaUserTie/> administrator  <AiFillFolderOpen/> Animal, Nature, Other <FaCommentAlt/> Leave a Comment
        <hr/>
        ...
        <hr/>
        <AiOutlineCalendar/> November 16, 2020  <FaUserTie/> administrator  <AiFillFolderOpen/> Nature, Other <AiFillTag/>  Mountain, Mountains
        <hr/>
      </div>
